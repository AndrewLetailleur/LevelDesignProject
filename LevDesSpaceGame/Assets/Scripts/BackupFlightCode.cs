...
public class BackupFlightCode : MonoBehaviour {
    ...
    public AudioSource thruster_SFX;
    public bool thrustSFX = false;
    ...
    void SFX() {
        ...
        if (thrustSFX && !thruster_SFX.isPlaying)
            thruster_SFX.Play();
        else if (!thrustSFX && thruster_SFX.isPlaying)
            thruster_SFX.Stop();
        //endif
    }
